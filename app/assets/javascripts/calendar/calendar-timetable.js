      ...
      $.each(schedule_days, function (_day, index) {
        ...
        for(i = 0; i < schedules_group_by_day.length; i++) {
          ...
          html += "<td class=\"lv-eventcell lv-title " + _class + "\"" +">";
            html += "<div class=\"s-title\"><a href=\"javascript:void(0)\"><span data-event-id=" + schedule.id + " class=\"plus\"><span class=\"glyphicon glyphicon-plus-sign\" id=\"icon\"></span>" + schedule.title + "</span></a></div>";
